...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--categories",
        nargs="+",
        default=["Angry", "Calm", "Disgust", "Neutral", "Fearful", "Happy", "Sad", "Surprised"],
        help="Category subfolder names to process (default: Angry, Calm, Disgust, Neutral, Fearful, Happy, Sad, Surprised)",
    )
